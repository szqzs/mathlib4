...
#guard_msgs in
example (x y : ℚ) (h1 : 3 * x + y < 4) (h2 : x < 2) : 4 * x + y ≤ 6 := by
  maximize 4 * x + y with H
  trivial

/-- info: Try this: have H : 5 * x + 3 * y ≤ 6 := by linarith -/
#guard_msgs in
example (x y : ℚ) (h1 : 4 * x + 2 * y < 4) (h2 : x + y < 2) : 5 * x + 3 * y ≤ 6 := by
...
#guard_msgs in
example (x y : ℚ) (h1 : x + y < 10) (h2 : x + 11 * y < 9) : x + 7 * y ≤ 47 / 5 := by
  maximize x + 7 * y with H
  trivial

/-- info: Try this: have H : -x - 7 * y ≤ 157 / 21 := by linarith -/
#guard_msgs in
example (x y : ℚ) (h1 : -2 * x - y < 10) (h2 : -x - 11 * y < 9) : -x - 7 * y ≤ 157 / 21 := by
  maximize -x - 7 * y with H
  trivial
...
#guard_msgs in
example (x y : ℚ) (h1 : 3 * x + y > -4) (h2 : x > -2) : -6 ≤ 4 * x + y := by
  minimize 4 * x + y with H
  trivial

/-- info: Try this: have H : -6 ≤ 5 * x + 3 * y := by linarith -/
#guard_msgs in
example (x y : ℚ) (h1 : 4 * x + 2 * y > -4) (h2 : x + y > -2) : -6 ≤ 5 * x + 3 * y := by
...
#guard_msgs in
example (x y : ℚ) (h1 : x + y > -10) (h2 : x + 11 * y > -9) : -47 / 5 ≤ x + 7 * y := by
  minimize x + 7 * y with H
  trivial

/-- info: Try this: have H : -157 / 21 ≤ -x - 7 * y := by linarith -/
#guard_msgs in
example (x y : ℚ) (h1 : -2 * x - y > -10) (h2 : -x - 11 * y > -9) : -157 / 21 ≤ -x - 7 * y := by
  minimize -x - 7 * y with H
  trivial
...
#guard_msgs in
example (x : ℚ) (h1 : 0 < x) (h2 : x < 10) : x / 2 ≤ 5 := by
  maximize x / 2 with H
  trivial
...
#guard_msgs in
example (x : ℚ) (h1 : 0 < x) (h2 : x < 10) : (1 / 2) * x ≤ 5 := by
  maximize (1 / 2) * x with H
  trivial

/-- info: Try this: have H : (1 / 2) * ε + (1 / 3) * ε ≤ 5 := by linarith -/
#guard_msgs in
example (ε : ℚ) (h1 : 0 < ε) (h2 : ε < 6) : (1 / 2) * ε + (1 / 3) * ε ≤ 5 := by
...
#guard_msgs in
example (x : ℚ) (h1 : 0 < x) (h2 : x < 10) : (1 / 1) * x ≤ 10 := by
...
#guard_msgs in
example (x : ℚ) (h1 : 0 < x) (h2 : x < 10) : 0.5 * x ≤ 5 := by
...
#guard_msgs in
example (x : ℚ) (h1 : 0 < x) (h2 : x < 10) : 1 * x ≤ 10 := by
  maximize 1 * x with H
  trivial

/-- info: Try this: have H : x ≤ 10 := by linarith -/
#guard_msgs in
example (x : ℚ) (h1 : 0 < x) (h2 : x < 10) : x ≤ 10 := by
  maximize x with H
  trivial
...
/-- info: Try this: have H : x + y ≤ 5 := by linarith -/
#guard_msgs in
example (x y : ℚ) (h1 : x + y ≤ 5) (h2 : x ≤ 3) : x + y ≤ 5 := by
  maximize x + y with H
  trivial
...
/-- info: Try this: have H : x ≤ 6 := by linarith -/
#guard_msgs in
example (x : ℚ) (h1 : x < 10) (h2 : x > 0) (h3 : x < 6) : x ≤ 6 := by
  maximize x with H
  trivial
...
/-- info: Try this: have H : x ≤ 10 := by linarith -/
#guard_msgs in
example (x : ℚ) (h1 : x > 0) (h2 : x < 10) (h3 : x > -5) : x ≤ 10 := by
  maximize x with H
  trivial
